    ...
    <ListStyle>
      <div className="picUpload">
        ...
        <div className="picInput">
          <Input value={text} onChange={(e)=>{setText(e.target.value)}} placeholder="图片描述" style={{height:'50px',width:'80%',margin:'15px 0'}}/>
          <Input value={type} onChange={(e)=>{setType(e.target.value)}} placeholder="图片类型" style={{height:'50px',width:'80%',margin:'15px 0'}}/>
          <Button onClick={submitPic} style={{width:'6rem',background:'skyblue',color:'#fff',borderRadius:'1rem',marginTop:'10px'}}>提交</Button>
        </div>
      </div>
      <List
        header={
